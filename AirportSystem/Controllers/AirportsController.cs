...
namespace AirportSystem.Controllers
{
    public class AirportsController : Controller
    {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            // Check if airport is referenced in Flights
            bool isAirportReferenced = _context.Flights.Any(f => f.DepartureAirportId == id || f.ArrivalAirportId == id);

            if (isAirportReferenced)
            {
                ModelState.AddModelError("", "This airport cannot be deleted because it is used in existing flights.");
                return View(airport);
            }
